...
MainSection:NewButton("Doors GUI V2", "Works", function()
...
MainSection:NewButton("MM2", "Script For Murder Mystery 2", function()
    loadstring(game:GetObjects("rbxassetid://4001118261")[1].Source)()
end)

MainSection:NewButton("Script For Flee The Ficality", "Script For FTF", function()
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/rblxscriptsnet/unfair/main/rblxhub.lua'),true))()
end)

MainSection:NewButton("Vape V4 For Bedwars", "TIP: ALWAYS USE ALTS TO NOT GET YOUR MAIN BANNED", function()
